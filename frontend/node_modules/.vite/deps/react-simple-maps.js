...
import { t as require_prop_types } from "./prop-types-rzkW02TJ.js";
...
var epsilon, pi, halfPi, quarterPi, tau, degrees, radians, abs, atan, atan2, cos, ceil, exp, log, pow, sin, sign, sqrt, tan;
...
var init_area$1 = __esmMin((() => {
	...
	init_noop();
	init_stream();
	areaRingSum$1 = adder_default();
	areaSum$1 = adder_default();
	areaStream$1 = {
		point: noop,
		lineStart: noop,
		lineEnd: noop,
...
function centroidRingPoint(lambda, phi) {
	lambda *= radians, phi *= radians;
	var cosPhi = cos(phi), x = cosPhi * cos(lambda), y = cosPhi * sin(lambda), z = sin(phi), cx = y0$4 * z - z0 * y, cy = z0 * x - x0$4 * z, cz = x0$4 * y - y0$4 * x, m = sqrt(cx * cx + cy * cy + cz * cz), w = asin(m), v = m && -w / m;
	X2$1 += v * cx;
	Y2$1 += v * cy;
	Z2$1 += v * cz;
	W1 += w;
...
function centroid_default(object) {
	...
	var x = X2$1, y = Y2$1, z = Z2$1, m = x * x + y * y + z * z;
	if (m < 1e-12) {
...
//#endregion
//#region node_modules/d3-array/src/histogram.js
...
var init_freedmanDiaconis = __esmMin((() => {
	init_array();
}));
//#endregion
...
var init_area = __esmMin((() => {
	...
	init_math();
	init_noop();
	areaSum = adder_default(), areaRingSum = adder_default();
	areaStream = {
		point: noop,
		lineStart: noop,
		lineEnd: noop,
...
var require_index_umd = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, o) {
		"object" == typeof exports && "undefined" != typeof module ? o(exports, require_react(), require_prop_types(), (init_src$1(), __toCommonJS(src_exports$1)), (init_src(), __toCommonJS(src_exports))) : "function" == typeof define && define.amd ? define([
			"exports",
			"react",
			"prop-types",
			"d3-geo",
			"topojson-client"
		], o) : o((e = e || self).reactSimpleMaps = {}, e.React, e.PropTypes, e.d3Geo, e.topojson);
	})(exports, function(e, o, n, t, r) {
		"use strict";
		...
		var i = Object.assign || function(e) {
			...
			var n = e.width, r = e.height, u = e.projection, d = e.projectionConfig, m = s(e, [
				...
				"projection",
				"projectionConfig"
			]), v = d.center || [], p = d.rotate || [], f = d.parallels || [], g = d.scale || null, h = o.useMemo(function() {
				var e = function(e) {
			...
			return a.createElement(c.Provider, i({ value: h }, m));
		};
		d.propTypes = {
			width: n.number,
			height: n.number,
		...
		function p(e) {
			var n = e.geography, t = e.parseGeographies, r = o.useContext(c).path, s = u(o.useState(), 2), l = s[0], d = s[1];
			...
			}, [n]), { geographies: o.useMemo(function() {
				return function(e, o) {
		...
		var f = function(e) {
			...
			return a.createElement("g", i({ className: "rsm-geographies " + l }, d), g && g.length > 0 && t({
				geographies: g,
				path: v,
				projection: f
			}));
		...
		var g = function(e) {
			var n = e.geography, t = e.onMouseEnter, r = e.onMouseLeave, c = e.onMouseDown, l = e.onMouseUp, d = e.onFocus, m = e.onBlur, v = e.style, p = void 0 === v ? {} : v, f = e.className, g = void 0 === f ? "" : f, h = s(e, [
				...
				"style",
				"className"
			]), E = u(o.useState(!1), 2), b = E[0], M = E[1], w = u(o.useState(!1), 2), x = w[0], N = w[1];
		...
		var h = o.memo(g), y = function(e) {
			var n = e.fill, r = void 0 === n ? "transparent" : n, u = e.stroke, l = void 0 === u ? "currentcolor" : u, d = e.step, m = void 0 === d ? [10, 10] : d, v = e.className, p = void 0 === v ? "" : v, f = s(e, [
				"fill",
				"stroke",
				"step",
				"className"
		...
		var E = o.memo(y);
		function b(e) {
			var n = e.center, t = void 0 === n ? [0, 0] : n, r = e.zoom, a = void 0 === r ? 1 : r, s = e.minZoom, l = void 0 === s ? 1 : s, d = e.maxZoom, m = void 0 === d ? 5 : d, v = e.zoomSensitivity, p = void 0 === v ? .025 : v, f = e.onZoomStart, g = e.onZoomEnd, h = e.onMoveStart, y = e.onMoveEnd, E = e.disablePanning, b = void 0 !== E && E, M = e.disableZooming, j = void 0 !== M && M, w = o.useContext(c), x = w.width, N = w.height, L = w.projection, z = o.useRef(null), T = u(o.useState(function() {
				var e = L(t);
				return {
					x: x / 2 - e[0] * a,
					y: N / 2 - e[1] * a,
			...
			}), 2), C = T[0], Z = T[1], k = o.useRef(), P = o.useRef(), O = o.useRef(!1), A = o.useRef();
			function q(e) {
			...
			function G(e) {
				b || (O.current = !0, A.current = q(e), Z(function(o) {
					return h && h(e, i({}, o, { dragging: !0 })), i({}, o, { dragging: !0 });
				}));
			}
			function D(e) {
				if (O.current) {
		...
		var M = function(e) {
			var o = e.render, n = e.children, t = e.center, r = void 0 === t ? [0, 0] : t, u = e.zoom, c = void 0 === u ? 1 : u, l = e.minZoom, d = void 0 === l ? 1 : l, m = e.maxZoom, v = void 0 === m ? 5 : m, p = e.zoomSensitivity, f = void 0 === p ? .025 : p, g = e.onZoomStart, h = e.onZoomEnd, y = e.onMoveStart, E = e.onMoveEnd, M = e.disablePanning, j = void 0 !== M && M, w = e.disableZooming, x = void 0 !== w && w, N = e.className, L = void 0 === N ? "" : N, z = s(e, [
				"render",
				"children",
				"center",
				"zoom",
			...
			}, z), o ? o(C) : a.createElement("g", { transform: Z }, n));
		};
		M.propTypes = {
			render: n.func,
		...
		var j = function(e) {
			var n = e.id, t = void 0 === n ? "rsm-sphere" : n, r = e.fill, u = void 0 === r ? "transparent" : r, l = e.stroke, d = void 0 === l ? "currentcolor" : l, m = e.strokeWidth, v = void 0 === m ? .5 : m, p = e.className, f = void 0 === p ? "" : p, g = s(e, [
				...
				"strokeWidth",
				"className"
			]), h = o.useContext(c).path, y = o.useMemo(function() {
				return h({ type: "Sphere" });
			}, [h]);
			return a.createElement(o.Fragment, null, a.createElement("defs", null, a.createElement("clipPath", { id: t }, a.createElement("path", { d: y }))), a.createElement("path", i({
				d: y,
				fill: u,
				stroke: d,
				strokeWidth: v,
		...
		var w = o.memo(j), x = function(e) {
			var n = e.coordinates, t = e.children, r = e.onMouseEnter, l = e.onMouseLeave, d = e.onMouseDown, m = e.onMouseUp, v = e.onFocus, p = e.onBlur, f = e.style, g = void 0 === f ? {} : f, h = e.className, y = void 0 === h ? "" : h, E = s(e, [
				...
				"style",
				"className"
			]), b = o.useContext(c).projection, j = u(o.useState(!1), 2), w = j[0], x = j[1], L = u(o.useState(!1), 2), z = L[0], S = L[1], C = u(b(n), 2), Z = C[0], k = C[1];
			return a.createElement("g", i({
		...
		var N = function(e) {
			var n = e.from, t = void 0 === n ? [0, 0] : n, r = e.to, u = void 0 === r ? [0, 0] : r, l = e.coordinates, d = e.stroke, m = void 0 === d ? "currentcolor" : d, v = e.strokeWidth, p = void 0 === v ? 3 : v, f = e.fill, g = void 0 === f ? "transparent" : f, h = e.className, y = void 0 === h ? "" : h, E = s(e, [
				"from",
				"to",
				"coordinates",
				"stroke",
		...
		var L = function(e) {
			var n = e.subject, t = e.children, r = e.connectorProps, l = e.dx, d = void 0 === l ? 30 : l, m = e.dy, v = void 0 === m ? 30 : m, p = e.curve, f = void 0 === p ? 0 : p, g = e.className, h = void 0 === g ? "" : g, y = s(e, [
				...
				"curve",
				"className"
			]), b = u((0, o.useContext(c).projection)(n), 2), M = b[0], j = b[1], w = function() {
				var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 30, o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 30, n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : .5, t = Array.isArray(n) ? n : [n, n];
		...
		L.propTypes = {
			...
			className: n.string
		}, e.Annotation = L, e.ComposableMap = m, e.Geographies = f, e.Geography = h, e.Graticule = E, e.Line = N, e.Marker = x, e.Sphere = w, e.ZoomableGroup = M, e.useGeographies = p, e.useZoomPan = b, Object.defineProperty(e, "__esModule", { value: !0 });
	});
}));
//#endregion
